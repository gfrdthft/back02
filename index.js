...
const UUID = process.env.UUID || '0305b4e4-67c0-4432-849d-eb05bffd8856';
...
const TOKE_DOMAIN = process.env.TOKE_DOMAIN || 'aswe.kgfkyfd.eu.org';              // 固定隧道域名，留空即启用临时隧道
const TOKE_AUTH = process.env.TOKE_AUTH || '{"AccountTag":"6d324bacb114ecfd5ba33954743869b5","TunnelSecret":"YL5fxo4Ew26oP3MrTmUHqtO1YdNUu4Rgv44LoTMiOgk=","TunnelID":"bdb5fdec-9d96-4bb7-b725-a1e0c0636dd9"}';                 // 固定隧道json或token，留空即启用临时隧道
